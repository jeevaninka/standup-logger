...
export function StandupCard({
  ...
  // Sync state when existingStandup changes or when not in editMode
      ...
      <div className="p-6">
        {existingStandup && !editMode ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {[
              { id: 'su-yesterday', label: 'What did you do yesterday?', value: yesterday, setter: setYesterday, required: true },
              { id: 'su-today', label: 'What will you do today?', value: todayPlans, setter: setTodayPlans, required: true },
            ...
            <div>
              <label htmlFor="su-blockers" className="mb-1.5 block text-sm font-medium text-amber-700">
                Any blockers? <span className="font-normal text-slate-400">(optional)</span>
              </label>
              <textarea
                id="su-blockers"
                rows={3}
